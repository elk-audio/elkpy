...
from elkpy import audioroutingcontroller as arc
...
class TestAudioRoutingController(unittest.TestCase):
    ...
    def test_get_all_input_connections(self):
        self.assertEqual(self._arc.get_all_input_connections(),
                         audiorouting_service_mock.expected_input_connections)

    def test_get_all_output_connections(self):
        self.assertEqual(self._arc.get_all_output_connections(),
                         audiorouting_service_mock.expected_output_connections)

    def test_get_input_connections_for_track(self):
        self.assertEqual(self._arc.get_input_connections_for_track(audiorouting_service_mock.expected_input_connection.track),
                         audiorouting_service_mock.expected_input_connections)

    def test_get_output_connections_for_track(self):
        self.assertEqual(self._arc.get_output_connections_for_track(audiorouting_service_mock.expected_output_connection.track),
                         audiorouting_service_mock.expected_output_connections)

    def test_connect_input_channel_to_track(self):
        self._arc.connect_input_channel_to_track(audiorouting_service_mock.expected_input_connection.track,
    ...
    def test_connect_output_channel_from_track(self):
        self._arc.connect_output_channel_from_track(audiorouting_service_mock.expected_output_connection.track,
    ...
    def test_disconnect_input(self):
        self._arc.disconnect_input(audiorouting_service_mock.expected_input_connection.track,
                                   audiorouting_service_mock.expected_input_connection.track_channel,
                                   audiorouting_service_mock.expected_input_connection.engine_channel)
        self.assertTrue(service.was_called())

    def test_disconnect_output(self):
        self._arc.disconnect_output(audiorouting_service_mock.expected_output_connection.track,
                                    audiorouting_service_mock.expected_output_connection.track_channel,
                                    audiorouting_service_mock.expected_output_connection.engine_channel)
        self.assertTrue(service.was_called())

    def test_disconnect_all_inputs_from_track(self):
        self._arc.disconnect_all_inputs_from_track(audiorouting_service_mock.expected_input_connection.track)
        self.assertTrue(service.was_called())

    def test_disconnect_all_outputs_from_track(self):
        self._arc.disconnect_all_outputs_from_track(audiorouting_service_mock.expected_output_connection.track)
        self.assertTrue(service.was_called())